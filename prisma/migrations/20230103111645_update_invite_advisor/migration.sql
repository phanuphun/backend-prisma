/*
  ...
  - Added the required column `Project_Invite_Advisor_Detail` to the `Project_Invite_Advisor` table without a default value. This is not possible if the table is not empty.
  - Added the required column `Project_Invite_Advisor_Reply` to the `Project_Invite_Advisor` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `project_invite_advisor` ADD COLUMN `Project_Invite_Advisor_Detail` VARCHAR(255) NOT NULL,
    ADD COLUMN `Project_Invite_Advisor_Reply` VARCHAR(255) NOT NULL;
